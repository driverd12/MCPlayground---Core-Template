...
- Compact-evidence-only completions now redact forbidden raw transcript and hidden-reasoning payloads before persistence while preserving the audit violation keys and `needs_review` status.
